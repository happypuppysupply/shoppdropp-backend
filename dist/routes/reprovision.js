...
const vpsProvisionerFixed_1 = require("../services/vpsProvisionerFixed");
 ...
 */
router.post('/:workerId/reprovision', auth_1.authenticate, async (req, res) => {
    try {
        ...
        if (worker.hetzner_server_id) {
            ...
            try {
                const hetzner = new hetznerService_1.HetznerService(process.env.HETZNER_API_TOKEN || '');
        ...
        const hetzner = new hetznerService_1.HetznerService(process.env.HETZNER_API_TOKEN || '');
        const provisioner = new vpsProvisionerFixed_1.VPSProvisionerFixed(hetzner);
...
//# sourceMappingURL=reprovision.js.map